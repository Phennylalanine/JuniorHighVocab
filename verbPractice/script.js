...
window.addEventListener("DOMContentLoaded", () => {
  ...
  function saveProgress() {
    localStorage.setItem("verb1_xp", xp);
    localStorage.setItem("verb1Levelr", level);
   }
  ...
  function loadProgress() {
    xp = Number(localStorage.getItem("verb1_xp")) || 0;
    level = Number(localStorage.getItem("verb1Levelr")) || 1;
    updateStats();
  }
